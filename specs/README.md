...
| 004    | `archive/004-account-login-system.md`            | Future     | Password/cookie account system proposal; not current runtime behavior.  |
| 005    | `archive/005-postgres-account-system.md`         | Proposed   | Postgres-backed account and cookie-session system proposal.             |
