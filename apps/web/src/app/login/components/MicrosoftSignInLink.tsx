  ...
  return (
    <Button
      ...
      className={cn(
        ...
        variant === 'login' &&
          'mt-7 h-[78px] w-full flex-none gap-[clamp(16px,6vw,28px)] rounded-xl border-[1.5px] border-[#c5c0ff] bg-white/95 px-4.5 text-[clamp(19px,6vw,24px)] font-semibold text-[#0b1027] shadow-[0_4px_10px_rgb(73_65_220_/_15%)] hover:border-[#aaa3ff] hover:bg-white hover:text-[#0b1027] hover:shadow-[0_6px_14px_rgb(73_65_220_/_18%)] active:border-[#8f87f3] active:bg-[#faf9ff] focus-visible:ring-[3px] focus-visible:ring-[#4b45e6] focus-visible:ring-offset-4 max-[390px]:gap-3.5 max-[390px]:text-lg [@media_(min-width:1100px)_and_(min-height:700px)_and_(min-aspect-ratio:4/3)]:mt-[33px] [@media_(min-width:1100px)_and_(min-height:700px)_and_(min-aspect-ratio:4/3)]:h-[94px] [@media_(min-width:1100px)_and_(min-height:700px)_and_(min-aspect-ratio:4/3)]:gap-10 [@media_(min-width:1100px)_and_(min-height:700px)_and_(min-aspect-ratio:4/3)]:px-8 [@media_(min-width:1100px)_and_(min-height:700px)_and_(min-aspect-ratio:4/3)]:text-[25px]',
        compactAfterError &&
